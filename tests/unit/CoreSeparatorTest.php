...
final class CoreSeparatorTest extends PluginTestCase {
    ...
    public function test_retrieve_core_separator_attributes() {
        ...
        // Debug: Output the full GraphQL response for errors.
        // if ( isset( $actual['errors'] ) ) {
        //     echo print_r( $actual['errors'], true );
        // }
        ...
        $this->assertEquals(
            [
                'cssClassName'    => 'custom-separator-class',
    ...
    public function test_retrieve_core_separator_attributes_two() {
        ...
        $this->assertEquals(
            [
                'cssClassName'    => 'wp-block-separator has-alpha-channel-opacity', 'align' => null,
                'anchor'          => null,
                'backgroundColor' => null,
                'className'       => null,
                'gradient'        => null,
